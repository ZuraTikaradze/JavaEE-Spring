...
public class HelloServiceServiceLocator extends org.apache.axis.client.Service implements hello.HelloServiceService {
    ...
    private java.lang.String HelloServicePort_address = "http://localhost:8080/SOAPDemo_war_exploded/hello";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.demo.cse.ge/", "HelloServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.demo.cse.ge/", "HelloServicePort"));
        }
